...
imagestart=IMG_Load("menu.png");

SDL_Surface *imagesave;
imagesave=IMG_Load("save1.jpg");
			...
			switch(event.type)
			{
                ...
                case SDLK_n:
					...
					break;
                          ...
                          case SDLK_u: 
		            SaveGame("save.txt",perso,b,vie,score);

		            break;
		            case SDLK_l: 
                             debut=0;
		            LoadGame("save.txt",&perso,&b,&vie,&score);
                            x=vie.valVie;
                            xscore=score.scoreActuel;
		            break;
...
if(debut==1){
 SDL_BlitSurface(imagestart, NULL, screen,0); 
}
...
if(pausegame==1){
 SDL_BlitSurface(imagesave, NULL, screen,0); 
   if(yes==1){  
continuer=0;}    
 if(cancel==1){  
pausegame=0;
